...
<body class="home">
    <div class="container-fluid display-table">
		...
		<!--menu-->
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" ng-controller="ListCtrl" id="navigation" ng-include="'resources/view/menu_forHome.html'">
            </div>
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
				...
				<!--user_dashboard-->
                <div class="user-dashboard" ng-controller="dashboardCtrl" ng-include="'resources/dashboard/AssetsManage.html'"></div>
            </div>
        </div>
    </div>
</body>
